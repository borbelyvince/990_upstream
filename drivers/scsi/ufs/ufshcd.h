...
struct ufs_hba {
	...
	#define UFSHCD_QUIRK_GET_GENERRCODE_DIRECT		0x100

	#define UFSHCD_QUIRK_UNRESET_INTR_AGGR			0x2000

	#define UFSHCD_QUIRK_GET_UPMCRS_DIRECT			0x4000

	#define UFSHCD_QUIRK_DUMP_DEBUG_INFO			0x8000
